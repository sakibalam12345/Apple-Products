...
const Itvwatch = () => {
    return (
        <div className="mt-24 ">
            <h1 className="text-center flex justify-center items-center text-5xl font-bold underline"><FaApple></FaApple> tv+</h1>
  ...
  <div id="slide1" className="carousel-item relative w-full">
    ...
    <h1 className='absolute text-5xl font-bold flex pt-[500px] pl-[1300px] '><FaApple></FaApple> tv+</h1>
